...
public class CalendarPickerView extends ViewPager
{
	...
	/** The day background res id. */
	private int dayBackgroundResId;
	
	/** The day text color res id. */
	...
	public CalendarPickerView(Context context, AttributeSet attrs)
	{
		...
		titleTextColor = a.getColor(
				...
				res.getColor(R.color.main_blue));
		...
		/*try
		{
			final int bg = a.getResourceId(R.styleable.CalendarPickerView_android_background, R.color.calendar_bg);
		...
		setPageMargin((int) (res.getDisplayMetrics().density * 10));
	...
	public class FluentInitializer
	{
		...
		/**
		 * Sets the short weekdays.
		 *
		 * @param newShortWeekdays the new short weekdays
		 * @return the fluent initializer
		 */
	 ...
	 *
	 * @param titleTypeface the new title typeface
	 */
	 ...
	 *
	 * @param dateTypeface the new date typeface
	 */
	...
	/**
	 * The listener interface for receiving cellClicked events.
	 * The class that is interested in processing a cellClicked
	 * event implements this interface, and the object created
	 * with that class is registered with a component using the
	 * component's <code>addCellClickedListener<code> method. When
	 * the cellClicked event occurs, that object's appropriate
	 * method is invoked.
	 *
	 * @see CellClickedEvent
	 */
	private class CellClickedListener implements MonthView.Listener
	{
		
		/* (non-Javadoc)
		 * @see com.squareup.timessquare.MonthView.Listener#handleClick(com.squareup.timessquare.MonthCellDescriptor)
		 */
		@Override
	 ...
	 *
	 * @param date the date
	 * @param selectedCal the selected cal
	 * @return the date
	 */
	...
	private static class MonthCellWithMonthIndex
	{
		...
		/**
		 * Instantiates a new month cell with month index.
		 *
		 * @param cell the cell
	 ...
	 *
	 * @param date the date
	 * @return the month cell with index by date
	 */
	...
	/**
	 * The Class MonthAdapter.
	 */
	private class MonthAdapter extends PagerAdapter
	{

		/**
		 * Instantiates a new month adapter.
		 */
		public MonthAdapter()
		{
			super();
		...
		public Object instantiateItem(ViewGroup container, int position)
		{
			...
			OnClickListener ocl = new OnClickListener() {
				...
				public void onClick(View v)
				{
					...
					{
						if (getCurrentItem() < getCount() - 1)
							setCurrentItem(getCurrentItem() + 1, true);
					}
				}
			};
			monthView.findViewById(R.id.prev).setOnClickListener(ocl);
			monthView.findViewById(R.id.next).setOnClickListener(ocl);
			return monthView;
		}
	 ...
	 * Contains date.
	 *
	 * @param selectedCals the selected cals
	 * @param cal the cal
	 * @return true, if successful
	 */
	 ...
	 *
	 * @param cal the cal
	 * @param minCal the min cal
	 * @param maxCal the max cal
	 * @return true, if successful
	 */
	...
	{
		return cal.get(MONTH) == month.getMonth()
				&& cal.get(YEAR) == month.getYear();
	}

	/**
	 * Checks if is date selectable.
	 *
	 * @param date the date
	 * @return true, if is date selectable
	 */
	...
	/**
	 * Sets the on date selected listener.
	 *
	 * @param listener the new on date selected listener
	 */
	 ...
	 *
	 * @param listener the new date selectable filter
	 */
	...
	/**
	 * The listener interface for receiving defaultOnInvalidDateSelected events.
	 * The class that is interested in processing a defaultOnInvalidDateSelected
	 * event implements this interface, and the object created
	 * with that class is registered with a component using the
	 * component's <code>addDefaultOnInvalidDateSelectedListener<code> method. When
	 * the defaultOnInvalidDateSelected event occurs, that object's appropriate
	 * method is invoked.
	 *
	 * @see DefaultOnInvalidDateSelectedEvent
	 */
			...
			OnInvalidDateSelectedListener
	{
		...
		/* (non-Javadoc)
		 * @see com.squareup.timessquare.CalendarPickerView.OnInvalidDateSelectedListener#onInvalidDateSelected(java.util.Date)
		 */
		@Override
